...
// metodos
    ...
    public function mostrarReservasNoDevueltas() {
        $this->conexion->consulta("SELECT r.*, u.nombre as nombre_usuario,u.apellidos as apellidos, u.socio as numero_socio, l.titulo as titulo
         FROM reservas r
    ...
    public function getReservasConFechaMenorAHoy() {
        $this->conexion->consulta("SELECT r.*, u.nombre as nombre,u.apellidos as apellidos, u.socio as numero_socio , l.titulo as titulo 
        FROM reservas r 
        INNER JOIN usuarios u ON u.id = r.id_usuario 
